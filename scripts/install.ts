...
console.log('Please wait while the discord bot gets installed on the discord server with id', guildId);
...
bot.start()
    ...
    .then(() => process.exit(0))
    .then(() => console.log('Installation successful you can now use the bot on your discord server.'))
    .catch((error) => {
